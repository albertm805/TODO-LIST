...
exports.default = function () {
  ...
  var savePatchToDisk = _ref5.savePatchToDisk;
...
function checkContent(contentPromise, savePatchToDisk, directory) {
  return contentPromise.map(function (_ref) {
    ...
    var hash = _ref2.hash;
    var es3Hash = _ref2.es3Hash;
    return hash !== es3Hash;
  }).map(function (_ref3) {
    var filename = _ref3.filename;
    var content = _ref3.content;
    var es3Content = _ref3.es3Content;
    return _bluebird2.default.props({
      filename: filename,
...
function checkString(content) {
  ...
  var savePatchToDisk = _ref4.savePatchToDisk;
  var directory = _ref4.directory;
  var _ref4$filename = _ref4.filename;
  var filename = _ref4$filename === undefined ? 'stringInput' : _ref4$filename;
